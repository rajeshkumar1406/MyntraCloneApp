...
const HomeItem = ({item}) => {
    ...
    <div className="price">
        ...
        <span className="discount">({item.discount_per}% OFF)</span>
    </div>
    {elementFound ? <button type="button" className="btn btn-add-bag btn-danger" onClick={handleRemove}><CgRemove /> Remove</button> : 
